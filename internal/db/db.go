...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getDistinctCategoriesStmt, err = db.PrepareContext(ctx, getDistinctCategories); err != nil {
		return nil, fmt.Errorf("error preparing query GetDistinctCategories: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getDistinctCategoriesStmt != nil {
		if cerr := q.getDistinctCategoriesStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getDistinctCategoriesStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getDistinctCategoriesStmt  *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getDistinctCategoriesStmt:  q.getDistinctCategoriesStmt,
