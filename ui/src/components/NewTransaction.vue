...
<template>
    <section class="new p-6">
        <div class="info mb-4">
            <h1 class="text-2xl font-bold mb-1">Add a new transaction</h1>
            <p class="text-gray-400">You can add a small description of your expenses and even add multiple expenses...
            </p>
        </div>
        <div class="form">
            <form @submit.prevent="handleSubmit" class="flex flex-col items-center">
                <textarea class="w-full textarea textarea-bordered"
                    placeholder="Type something like '420 for groceries, 800 for phone bill'" v-model="inputValue"
                        ...
                        <td>
                            <div class="flex space-x-2">
                                ...
                                <button v-else class="btn btn-ghost btn-sm hover:bg-neutral-800 hover:text-white"
                                    @click="editTransaction(transaction)">Edit</button>
